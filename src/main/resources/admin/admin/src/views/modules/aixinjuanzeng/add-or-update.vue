<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="捐赠标题" prop="juanzengbiaoti">
          <el-input v-model="ruleForm.juanzengbiaoti" 
              placeholder="捐赠标题" clearable  :readonly="ro.juanzengbiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="捐赠标题" prop="juanzengbiaoti">
              <el-input v-model="ruleForm.juanzengbiaoti" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="捐赠地点" prop="juanzengdidian">
          <el-input v-model="ruleForm.juanzengdidian" 
              placeholder="捐赠地点" clearable  :readonly="ro.juanzengdidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="捐赠地点" prop="juanzengdidian">
              <el-input v-model="ruleForm.juanzengdidian" 
                placeholder="捐赠地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="微信账号" prop="weixinzhanghao">
          <el-input v-model="ruleForm.weixinzhanghao" 
              placeholder="微信账号" clearable  :readonly="ro.weixinzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="微信账号" prop="weixinzhanghao">
              <el-input v-model="ruleForm.weixinzhanghao" 
                placeholder="微信账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="微信用户名" prop="weixinyonghuming">
          <el-input v-model="ruleForm.weixinyonghuming" 
              placeholder="微信用户名" clearable  :readonly="ro.weixinyonghuming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="微信用户名" prop="weixinyonghuming">
              <el-input v-model="ruleForm.weixinyonghuming" 
                placeholder="微信用户名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="捐赠内容" prop="juanzengneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.juanzengneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.juanzengneirong" label="捐赠内容" prop="juanzengneirong">
                    <span v-html="ruleForm.juanzengneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	juanzengneirong : false,
	fabushijian : false,
	jigoumingcheng : false,
	juanzengdidian : false,
	fengmiantupian : false,
	weixinzhanghao : false,
	weixinyonghuming : false,
      },
      ruleForm: {
        juanzengbiaoti: '',
        juanzengneirong: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='juanzengbiaoti'){
            this.ruleForm.juanzengbiaoti = obj[o];
	    this.ro.juanzengbiaoti = true;
            continue;
          }
          if(o=='juanzengneirong'){
            this.ruleForm.juanzengneirong = obj[o];
	    this.ro.juanzengneirong = true;
            continue;
          }
          if(o=='fabushijian'){
	    ...
	    this.ro.fengmiantupian = true;
          ...
          if(o=='weixinzhanghao'){
            this.ruleForm.weixinzhanghao = obj[o];
	    this.ro.weixinzhanghao = true;
            continue;
          }
          if(o=='weixinyonghuming'){
            this.ruleForm.weixinyonghuming = obj[o];
	    this.ro.weixinyonghuming = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.juanzengneirong = this.ruleForm.juanzengneirong.replace(reg,'../../../springboot60h87/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
